...
class Seq2seq_Model(object):
    ...
    def __init__(self, num_emb, batch_size, emb_dim, encoder_num_units, emb_data,
        ...
        self.response = tf.placeholder(tf.float32, shape=[self.batch_size, self.max_sequence_length]) # get from rollout policy and discriminator
        ...
        #pad
        pred_len_to_fill = self.max_sequence_length - tf.shape(self.g_predictions)[1]
